      ...
      <nav className=" bg text-xl border-gray-200 dark:bg-gray-900 dark:border-gray-700 p-7">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <Link to="#" className="flex items-center space-x-3 rtl:space-x-reverse">
            <span className="self-center text-3xl font-bold whitespace-nowrap text-white">START FRAMEWORK
            </span>
          </Link>
          ...
          <div className="hidden w-full md:block md:w-auto bg " id="navbar-dropdown">
            <ul className="flex  flex-col font-medium p-4 md:p-0 mt-4 border  rounded-lg md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0  dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              <li>
              <NavLink to="/about" className={(x) => x.isActive ? " bgBasic block py-2 px-3 text-white rounded-sm hover:bg-gray-100 md:hover:bg-transparent dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent" : "block py-2 px-3 text-white rounded-sm hover:bg-gray-100 md:hover:bg-transparent dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"}>ABOUT</NavLink>
              </li>
              <li>
              <NavLink to="/protfolio" className={(x) => x.isActive ? " bgBasic block py-2 px-3 text-white rounded-sm hover:bg-gray-100 md:hover:bg-transparent dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent" : "block py-2 px-3 text-white rounded-sm hover:bg-gray-100 md:hover:bg-transparent dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"}>PORTFOLIO</NavLink>
              </li>
